...
Este é um projeto base (template) em LaTeX para desenvolvimento de **Relatórios de Estágio Supervisionado**, utilizando a classe **abnTeX2**. Ele foi customizado especificamente para atender aos padrões da **UNIJUÍ** (Universidade Regional do Noroeste do Estado do Rio Grande do Sul).
